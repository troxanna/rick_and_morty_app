...
import 'feature/domain/usecases/search_persons.dart';
import 'feature/presentation/bloc/person_list_bloc/person_list_bloc.dart';
...
Future<void> init() async {
  // BLoC / Cubit
  sl.registerFactory(
    () => PersonListBloc(getPersons: sl<GetAllPersons>()),
  );
  sl.registerFactory(
